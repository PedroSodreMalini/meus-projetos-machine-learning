# Regressão Logística - Classificador de Qualidade de Frutas para Entrega
...
## Resumo
Um classificador binário para prever a qualidade(*'good'* ou *'bad'*) das frutas recebidas por uma cooperativa agrícola usando o algoritmo de regressão logística.
